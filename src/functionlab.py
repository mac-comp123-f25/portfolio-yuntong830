...
#this code draw 5 flowers
#the shape layered by overlaping circles and a turtle's shape
#colors involved dark green,light sky blue, spring green, dark red and light coral
#Firstly it shapes 5 green circles, secondly 5 red small circles, then a purple circle, last a yellow tutle
#5 turtles are in the code
